...
if __name__=='__main__':
    ...
    if N_MPS > 1:
        amass_smplx_path = '/mnt/hdd/datasets/AMASS-Canonicalized-locomotion-MPx{:d}/data'.format(N_MPS)
    else:
        amass_smplx_path = '/mnt/hdd/datasets/AMASS-Canonicalized-locomotion-MP/data'
